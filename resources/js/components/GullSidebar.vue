     ...
     <div class="side-content-wrap">
            <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                <ul class="navigation-left">
                    <li class="nav-item" data-item="dashboard" ><router-link to="/admin/home" class="nav-item-hold" href="#"><i class="nav-icon i-Bar-Chart"></i><span class="nav-text">Dashboard</span></router-link>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item" ><router-link :to="{ name: 'admin.multiimage'}" class="nav-item-hold" href="#"><i class="nav-icon i-Library"></i><span class="nav-text">UI kits</span></router-link>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item" ><a class="nav-item-hold" href="#"><i class="nav-icon i-Suitcase"></i><span class="nav-text">Extra kits</span></a>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item" Xdata-item="apps"><a class="nav-item-hold" href="#"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Apps</span></a>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item" Xdata-item="widgets"><a class="nav-item-hold" href="#"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Widgets</span></a>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item" Xdata-item="charts"><a class="nav-item-hold" href="#"><i class="nav-icon i-File-Clipboard-File--Text"></i><span class="nav-text">Charts</span></a>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item" Xdata-item="forms"><a class="nav-item-hold" href="#"><i class="nav-icon i-File-Clipboard-File--Text"></i><span class="nav-text">Forms</span></a>
                        <div class="triangle"></div>
                    </li>
                    ...
                    <li class="nav-item active" Xdata-item="others"><a class="nav-item-hold" href="#"><i class="nav-icon i-Double-Tap"></i><span class="nav-text">Others</span></a>
                        <div class="triangle"></div>
                    </li>
            ...
            <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                ...
                <ul class="childNav" data-parent="dashboard">
                    <li class="nav-item"><router-link exact :to="{name : 'todo'}" ><i class="nav-icon i-Clock-3"></i><span class="item-name"> Todo List Project </span></router-link></li>
                    <li class="nav-item"><router-link exact to="/admin/multiimage" ><i class="nav-icon i-Clock-4"></i><span class="item-name"> Multi Image </span></router-link></li>
                    <li class="nav-item"><router-link exact :to="{name : 'father.slot'}" ><i class="nav-icon i-Over-Time"></i><span class="item-name"> Slot - (father)</span></router-link></li>
                    <li class="nav-item"><router-link exact to="/admin/watcher"><i class="nav-icon i-Clock"></i><span class="item-name"> Watcher </span></router-link></li>
                </ul>
