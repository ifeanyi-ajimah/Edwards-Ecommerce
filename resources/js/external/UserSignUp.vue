...
<div id="pricing" class="container-fluid">
  <div class="text-center">
    ...
    <h4> Kindly Enter your details to sign up as a Customer. </h4>
  </div>
      ...
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
                <form>
                    ...
                    <input type="submit" @click.prevent="addNewUser" :disabled="form_submitting" class="btn btn-primary" :value="form_submitting ? 'Saving data...' : 'Submit' "/> 
                </form>
        </div>
      </div>      
    </div>     
